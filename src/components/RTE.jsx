...
export default function RTE({name, control, label, defaultValue ="Write a new Post!"}) {
  return (
    ...
    render={({field: {onChange}}) => (
      <Editor
      apiKey='5re612o3lb98ehkkuf73b76dqsordizmnnj0yo79n11sbqxb'
      init={{
        plugins: [
        ...
        tinycomments_author: 'Venkatesh Ramandham',
